...
defaults = {
    'crosshair_center': [35.1796, 129.0756], 'base_zoom': 14, 'map_key': 6000,
...
# use_container_width=True를 사용하여 가로를 꽉 채웁니다.
map_data = st_folium(m, use_container_width=True, height=720, key=f"map_{sd.map_key}")
